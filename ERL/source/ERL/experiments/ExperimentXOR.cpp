...
float ExperimentXOR::evaluate(erl::Field2DGenes &fieldGenes, const neat::EvolverSettings &settings,
	...
	erl::ComputeSystem &cs, std::mt19937 &generator)
{
	...
	field.create(fieldGenes, cs, 10, 10, 1, 2, 1, randomImage, activationFunctions, activationFunctionNames, minInitRec, maxInitRec, generator, logger);
