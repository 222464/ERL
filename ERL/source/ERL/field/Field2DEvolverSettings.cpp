...
: _minInitWeight(-0.5f),
_maxInitWeight(0.5f),
_updateCrossoverAverageChance(0.3f),
_neAddNodeChance(0.09f),
_neAddConnectionChance(0.17f),
_neWeightPerturbationChance(0.1f),
_neWeightPerturbationStdDev(0.025f),
...
_mutateInputStrengthChance(0.15f),
_maxInputStrengthPerturbation(1.0f),
...
_maxConnectionStrengthPerturbation(0.4f),
...
_maxNodeOutputStrengthPerturbation(0.4f),
